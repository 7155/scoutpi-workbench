...
This performs a provider model-list preflight and writes a report under `exports/pi_harness/`. It does not make a model request. To verify that the real Pi RPC process and all six public extensions initialize, run:
