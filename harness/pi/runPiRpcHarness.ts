...
async function main(): Promise<void> {
  ...
  if (rpcSmoke) {
    ...
    const extensions = ["scoutpi-context", "scoutpi-governance", "scoutpi-observability", "scoutpi-checkpoint", "scoutpi-earth"].flatMap((name) => ["--extension", join(root, `.pi/extensions/${name}/index.ts`)]);
